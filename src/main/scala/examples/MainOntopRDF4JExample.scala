...
class MainOntopRDF4JExample extends App {

  val db_path = Paths.get("target/test_comuni-db").normalize().toString()
  ...
  val r2rmlFile = Paths.get("src/test/resources/examples/ontop/daf/test_anpr_stati_esteri_v01.r2rml.ttl").toUri().toString()
